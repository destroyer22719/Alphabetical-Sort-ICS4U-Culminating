...
describe("to test the quickSort function", () => {
    ...
    test("Error handling", () => {
        ...
        const unsorted2 = ["c", "f", "b", "a", "g", "d", "e", "h", "i", {}];
        const unsorted3 = [
            "c",
            { myArray: [1, 2, 3] },
            "b",
        ...
        expect(() => quickSort(unsorted1)).toThrow(
            "Invalid data, must be an array of strings and or numbers only"
        );
        expect(() => quickSort(unsorted2)).toThrow(
            "Invalid data, must be an array of strings and or numbers only"
        );
        expect(() => quickSort(unsorted3)).toThrow(
            "Invalid data, must be an array of strings and or numbers only"
        );
    });
});
